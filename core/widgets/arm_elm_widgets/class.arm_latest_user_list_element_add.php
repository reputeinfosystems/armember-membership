			...
			foreach( $users as $us ){
				...
				$output .= "<div class='arm_slider_widget_wrapper arm_widget_wrapper_{$random_inner_key}'>";
					...
					$output .= "<div class='arm_slider_widget_content_wrapper'>";
						...
						$output .= "<a href='{$profile_link}' class='arm_slider_widget_profile_link'><span>".arm_get_user_meta($user_id,'first_name',true).' '.arm_get_user_meta($user_id,'last_name',true)."</span></a>";
