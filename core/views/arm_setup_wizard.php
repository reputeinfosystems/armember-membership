	...
	<div class="arm-ws-steps-belt">
		...
		<div class="arm-ws-step-box" data-page_id='<?php echo esc_attr($arm_counter); $arm_counter += 1; ?>'>
			<div class="arm-ws-steps-icon-wrapper">
				<span>
					<svg class="arm-ws-step-activate-svg" width="18" style="display:block; margin: 0 auto;" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
						<g clip-path="url(#clip0_8142_2436)">
							<path d="M7.96212 17.9876C3.48042 17.4717 0 13.6551 0 9.02351C0 4.03996 4.02943 0 9 0C13.9705 0 18 4.03996 18 9.02351C18 13.6765 15.0456 13.2939 12.5221 12.9671C11.0668 12.7786 9.75474 12.6086 9.23571 13.4342C8.88066 13.9987 9.26442 14.7027 9.73512 15.1747C10.3233 15.7643 10.3233 16.7203 9.73512 17.31C9.26442 17.7819 8.62344 18.0638 7.96212 17.9876ZM8.1765 4.51154C8.1765 5.25906 7.57206 5.86506 6.8265 5.86506C6.08092 5.86506 5.4765 5.25906 5.4765 4.51154C5.4765 3.764 6.08092 3.15801 6.8265 3.15801C7.57206 3.15801 8.1765 3.764 8.1765 4.51154ZM4.05 9.92586C4.79559 9.92586 5.4 9.31984 5.4 8.57233C5.4 7.82482 4.79559 7.21879 4.05 7.21879C3.30441 7.21879 2.7 7.82482 2.7 8.57233C2.7 9.31984 3.30441 9.92586 4.05 9.92586ZM13.95 9.92586C14.6956 9.92586 15.3 9.31984 15.3 8.57233C15.3 7.82482 14.6956 7.21879 13.95 7.21879C13.2044 7.21879 12.6 7.82482 12.6 8.57233C12.6 9.31984 13.2044 9.92586 13.95 9.92586ZM11.25 5.86526C11.9956 5.86526 12.6 5.25927 12.6 4.51174C12.6 3.76421 11.9956 3.15821 11.25 3.15821C10.5044 3.15821 9.9 3.76421 9.9 4.51174C9.9 5.25927 10.5044 5.86526 11.25 5.86526Z" fill="#637799"/>
						</g>
						<defs>
							<clipPath id="clip0_8142_2436">
								<rect width="20" height="20" fill="white"/>
							</clipPath>
						</defs>
					</svg>
			...
			<div class="arm-ws-steps-text"><?php esc_html_e('Front-end Appearance','armember-membership'); ?></div>
		</div>
...
<div class="arm-wizard-setup-container arm-ws-is-lic-page arm_setup_wizard_page_<?php echo esc_attr($arm_sub_counter);?> " id="arm_setup_wizard_page_<?php echo esc_html($arm_sub_counter);?>">
	...
	<div class="arm-ws-license-part-content arm-ws-account-setup">
		<div class="arm-ws-lic-con-heding-area">
			<div class="arm-lic-con-page-count"><?php echo str_pad($arm_sub_counter,2,'0',STR_PAD_LEFT); $arm_sub_counter = $arm_sub_counter + 1; //phpcs:ignore ?></div>
			<div class="arm-lic-con-page-info">
				<h2 class="arm-lic-page-heding"><?php esc_html_e('Front-end Appearance','armember-membership'); ?></h2>
				<p class="arm-lic-page-disc"><?php esc_html_e('Frontend Appearance allows you to customize the look and feel of your website by selecting colors and fonts. These settings will be applied to the Login, Registration, and Setup forms','armember-membership'); ?>.</p>
			</div>
		</div>
		<div class="arm-lic-page-content-wrapper arm-lic-opt-com-wapper arm-content-access-wrapper">
		<?php
		...
		$frontColorOptions = apply_filters('arm_front_font_settings_type', $frontColorOptions);

		if (!empty($frontColorOptions)) :

			$frontOptions = isset($arm_default_front_settings['color']) ? $arm_default_front_settings['color'] : array();
			$frontFont     = isset($arm_default_front_settings['font']['font_family']) ? $arm_default_front_settings['font']['font_family'] : 'Poppins';

			$frontHtmlOutput  = '<div class="arm_setting_main_content arm_padding_0 arm_margin_top_28 arm_margin_left_16 arm_wizard_appearance_main_container">';
			$frontHtmlOutput .= '<div class="form-field arm_width_100_pct">';
			$frontHtmlOutput .= '<div class="left_content">';
			$frontHtmlOutput .= '<div class="arm-form-table-label arm_form_header_label arm-setting-hadding-label arm_font_size_16 arm_margin_bottom_0 arm_width_100_pct">' . esc_html__('Member Panel Colors','armember-membership') . '</div>';
			$frontHtmlOutput .= '</div>';
			$frontHtmlOutput .= '<div class="arm_wizard_appearance_color_container arm_margin_top_16">';
			$frontHtmlOutput .= '<div class="arm_form_field_block arm_display_flex arm_font_color_wrapper">';

			foreach ($frontColorOptions as $key => $title) {
				$fontVal = !empty($frontOptions[$key]) ? sanitize_text_field($frontOptions[$key]) : '#000000';

				$frontHtmlOutput .= '<div class="arm_font_color_item">';
				$frontHtmlOutput .= '<div class="arm_front_end_appearance_color_block">';
				$frontHtmlOutput .= '<div class="arm_front_font_color arm_margin_right_0">';
				$frontHtmlOutput .= '<input type="text"  autocomplete="off" id="arm_front_font_color_' . esc_attr($key) . '" name="appearance_settings[color][' . esc_attr($key) . ']" class="arm_colorpicker" value="' . esc_attr($fontVal) . '">';
				$frontHtmlOutput .= '</div>';
				$frontHtmlOutput .= '<div class="arm-form-table-label arm_padding_left_0 arm_font_size_15 arm_panel_color_label">' . esc_html($title) . '</div>';
				$frontHtmlOutput .= '</div>';
				$frontHtmlOutput .= '</div>';
			}
			...
			$frontFont = sanitize_text_field($frontFont);
			$frontHtmlOutput .= '<div class="arm_wizard_appearance_font_container arm_margin_bottom_30 arm_padding_bottom_24">';
			$frontHtmlOutput .= '<div class="left_content arm_margin_top_40">';
			$frontHtmlOutput .= '<div class="arm-form-table-label arm_form_header_label arm-setting-hadding-label arm_font_size_16 arm_margin_bottom_0 arm_width_100_pct">' . esc_html__('Font', 'armember-membership') . '</div>';
			$frontHtmlOutput .= '</div>';
			$frontHtmlOutput .= '<div class="arm_margin_top_16 arm_appearance_select_label"><label class="arm-form-table-label">' . esc_html__('Select Font', 'armember-membership') . '</label></div>';
			$frontHtmlOutput .= '<div><input type="hidden" id="arm_front_font_family" name="appearance_settings[font][font_family]" value="' . esc_attr($frontFont) . '"/></div>';
			$frontHtmlOutput .= '<dl class="arm_selectbox column_level_dd arm_width_362 arm_margin_right_10">';
			$frontHtmlOutput .= '<dt><span></span><input type="text" style="display:none;" value="" class="arm_autocomplete"  /><i class="armfa armfa-caret-down armfa-lg"></i></dt>';
			$frontHtmlOutput .= '<dd><ul data-id="arm_front_font_family">';
			$frontHtmlOutput .= $arm_member_forms->arm_fonts_list();
			$frontHtmlOutput .= '</ul></dd>';
			$frontHtmlOutput .= '</dl>';
			$frontHtmlOutput .= '</div>';
			...
			echo $frontHtmlOutput; //phpcs:ignore
...
<div class="arm-wizard-setup-container arm-ws-is-lic-page arm_setup_wizard_page_<?php echo esc_attr($arm_sub_counter);?> ">
	...
	$memeber_panel_page_id = $page_settings['member_panel_page_id'];
	?>
	<div class="arm-ws-license-part-content arm-ws-account-setup arm-thank-you-wapper">
		...
		<div class="arm-thank-you-short-code-list-row"> 
			...
			<div class="arm-short-code-wapper" id="arm_member_panel_link">
				<h4 class="arm-short-code-heding"><?php esc_html_e('Member Panel','armember-membership');?></h4>
				<div class="arm-short-code-text arm_setup_click_to_copy_text" data-code="<?php echo esc_html(get_permalink($memeber_panel_page_id));?>">
					<span class="armCopyText"><?php echo esc_html(get_permalink($memeber_panel_page_id));?></span> 
					<img class="arm-ws-acc-img" src="<?php echo esc_attr(MEMBERSHIPLITE_IMAGES_URL).'/content_copy_icon.webp' //phpcs:ignore ?>" alt="armember">
					<span class="arm_copied_text arm_setup_copied_text"><img src='<?php echo esc_attr(MEMBERSHIPLITE_IMAGES_URL)."/copied_ok.png" //phpcs:ignore ?>' alt="ok"><?php esc_html_e('Link Copied!','armember-membership');?></span>
				</div>
			</div>
