	...
	?>
		<script type="text/javascript">
			...
			jQuery(document).on('click','.popup_wrapper.arm_black_friday_bpopup .popup_content_text',function(){
				//window.location.replace("https://www.armemberplugin.com/pricing/?utm_source=lite_version&utm_medium=lite_version_popup&utm_campaign=black-friday-sale-2025");
				window.location.replace("https://www.armemberplugin.com/pricing/?utm_source=lite_popup&utm_medium=popup&utm_campaign=spring-sale-2025");
			});
		</script>
	<?php
	}
